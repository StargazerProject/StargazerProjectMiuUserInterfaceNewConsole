...
public class MainFrameLogoJlabel extends JLabel {
	...
	public JLabel mainFrameLogoJlabel(ImageIcon backgroundLogo,Point origin,MainFrame mainFrame) {
		LogoClickListener logoClickListener = new LogoClickListener(mainFrame);
